...
# CSS: Hanya mengatur header tabel dan lebar. Body tabel dibiarkan "auto" sesuai system.
st.markdown("""
<style>
            ...
            def style_color(row):
                ...
                for col, val in row.items():
                    if col in ['waktu', 'index']:
                        ...
                        # Kembalikan string kosong ('') untuk sel waktu & kosong.
                        # Ini artinya: "Ikuti warna default system".
                        # (Hitam di Dark Mode, Putih di Light Mode).
                        styles.append('') 
                        continue
